...
//------- begin assistants_arr --> 
$assistants_arr_=array(
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "desired_column_order"=>[
        ...
        'assistants' => ['primkey','record_id', "name",'assitant_id', 'remark','login_password','date_booked'],

    ],
    
    //infosnippets //"primkey" , "record_id" , "media" , "title" , "tag" , "notes" , "date_created" ,
    ...
    "skip_cols_profile"=>["status"],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>["status","column_name2..."],
    ...
    "rename_cols_array"=>['client_id'=>'Client name'],
    ...
    "new_label_buttons_arr"=>['infosnippets'=>'plus-circle:New Note : Note / {{tag}} / {{title}}'],
    //sample 
